...
window.DATA = {
  ...
  activities: [
    ...
    {id:'act8',type:'Site Visit',subject:'Centre Aquatique — Feasibility',date:'2026-03-18',time:'08:30',duration:240,status:'Planned',accountId:'a1',accountName:'Bouygues Construction',contactId:'c1',contact:'Jean-Pierre Martin',contactRole:'Directeur Travaux',opportunityId:'o5',opportunityName:'Centre Aquatique – Extension',owner:'Thomas Girard',location:'Centre Aquatique — Aubervilliers',purpose:'Assess glazing and humidity conditions.',participants:[{name:'Jean-Pierre Martin',company:'Bouygues Construction',role:'Directeur Travaux',contactId:'c1'}],notes:[],tasks:[],documents:[]},
