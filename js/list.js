...
.lv2-key-title{font-size:13px;font-weight:700;color:var(--text-muted);margin-bottom:10px;letter-spacing:.01em}\
.lv2-key-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}\
.lv2-key-card{background:var(--card);border-radius:11px;padding:16px;border:1px solid var(--border);box-shadow:0 1px 3px rgba(0,0,0,.04);cursor:pointer;transition:all .18s}\
.lv2-key-card:hover{box-shadow:0 4px 16px rgba(0,0,0,.08);transform:translateY(-1px)}\
.lv2-key-inner{display:flex;align-items:center;gap:12px}\
.lv2-key-avatar{width:52px;height:52px;border-radius:50%;object-fit:cover;border:2px solid var(--border);flex-shrink:0;background:#f8fafc}\
.lv2-key-avatar-placeholder{width:52px;height:52px;border-radius:50%;background:#f1f5f9;border:2px solid var(--border);display:flex;align-items:center;justify-content:center;flex-shrink:0}\
.lv2-key-avatar-acct{border-radius:10px}\
.lv2-key-initials{font-size:16px;font-weight:700;color:var(--text-light)}\
.lv2-key-info{flex:1;min-width:0}\
.lv2-key-name{font-size:13.5px;font-weight:700;color:var(--text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\
.lv2-key-meta{font-size:12px;color:var(--text-muted);margin-top:1px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}\
.lv2-key-pipeline{font-size:12.5px;margin-top:3px}\
.lv2-key-pipeline-val{font-weight:700;color:var(--accent)}\
.lv2-key-pipeline-lbl{color:var(--text-light);font-size:11.5px}\
.lv2-key-extra{display:flex;align-items:center;gap:6px;margin-top:10px;padding-top:9px;border-top:1px solid #f1f5f9}\
.lv2-key-extra-dot{width:6px;height:6px;border-radius:50%;flex-shrink:0}\
.lv2-key-extra-text{font-size:11.5px;color:var(--text-muted)}\
...
@media(max-width:1024px){\
  .lv2-key-cards{grid-template-columns:repeat(3,1fr);gap:10px}\
  .lv2-table-wrap{overflow-x:auto}\
  .lv2-table{min-width:700px}\
}\
@media(max-width:640px){\
  .lv2-key-cards{grid-template-columns:1fr;gap:8px}\
  .lv2-key-card{padding:12px}\
  .lv2-key-avatar,.lv2-key-avatar-placeholder{width:42px;height:42px}\
...
function renderListViewV2(items, columns, container, objKey) {
  ...
  if (keyRecords.length > 0) {
    keyHTML = '<div class="lv2-key-section">' +
      '<div class="lv2-key-title">Key ' + (isContacts ? 'Contacts' : 'Accounts') + '</div>' +
  ...
  container.innerHTML = keyHTML + tableHTML;
